...
//             if (!qTable[stateStr]) return 'down'; // Default action if state is not in qTable
...
//     function getReward() {
//         // Simple reward: +10 for clearing a line, -1 for each step
//         let reward = -1;
//         for (let i = 0; i < 199; i += width) {
//             const row = [i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8, i + 9];
//             if (row.every(index => squares[index].classList.contains('taken'))) {
...
//     // Override control function to use Q-learning
//     function control() {
...
//     // Override start button event to initiate Q-learning
//     startBtn.addEventListener('click', () => {
//         if (timerId) {
//             clearInterval(timerId);
//             timerId = null;
